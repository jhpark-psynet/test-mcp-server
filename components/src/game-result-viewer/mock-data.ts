...
export const mockBasketballLiveData: BasketballGameData = {
  ...
  homeTeam: {
    ...
    players: [
      { number: 30, name: 'Stephen Curry', position: 'G', minutes: 27, rebounds: 3, assists: 5, points: 26, fgm: 8, fga: 17, tpm: 4, tpa: 9, steals: 2, blocks: 0 },
      { number: 11, name: 'Klay Thompson', position: 'G', minutes: 22, rebounds: 2, assists: 1, points: 16, fgm: 5, fga: 11, tpm: 3, tpa: 6, steals: 1, blocks: 0 },
      { number: 23, name: 'Draymond Green', position: 'F', minutes: 24, rebounds: 6, assists: 7, points: 5, fgm: 2, fga: 5, tpm: 0, tpa: 1, steals: 2, blocks: 2 },
      { number: 5, name: 'Jonathan Kuminga', position: 'F', minutes: 19, rebounds: 4, assists: 2, points: 18, fgm: 7, fga: 12, tpm: 1, tpa: 3, steals: 1, blocks: 1 },
      { number: 15, name: 'Kevon Looney', position: 'C', minutes: 16, rebounds: 7, assists: 1, points: 4, fgm: 2, fga: 3, tpm: 0, tpa: 0, steals: 0, blocks: 1 },
    ],
    recentGames: ['W', 'W', 'L', 'W', 'W'],
  },
  awayTeam: {
    ...
    players: [
      { number: 23, name: 'LeBron James', position: 'F', minutes: 28, rebounds: 7, assists: 8, points: 22, fgm: 8, fga: 16, tpm: 1, tpa: 4, steals: 1, blocks: 1 },
      { number: 3, name: 'Anthony Davis', position: 'C', minutes: 26, rebounds: 10, assists: 2, points: 20, fgm: 7, fga: 14, tpm: 0, tpa: 1, steals: 1, blocks: 3 },
      { number: 15, name: 'Austin Reaves', position: 'G', minutes: 22, rebounds: 2, assists: 4, points: 13, fgm: 4, fga: 9, tpm: 2, tpa: 5, steals: 2, blocks: 0 },
      { number: 1, name: "D'Angelo Russell", position: 'G', minutes: 20, rebounds: 1, assists: 5, points: 9, fgm: 3, fga: 8, tpm: 1, tpa: 3, steals: 1, blocks: 0 },
      { number: 12, name: 'Rui Hachimura', position: 'F', minutes: 18, rebounds: 3, assists: 1, points: 5, fgm: 2, fga: 5, tpm: 0, tpa: 1, steals: 0, blocks: 0 },
    ],
    recentGames: ['L', 'W', 'W', 'L', 'W'],
  },
  gameRecords: [
...
// 경기 종료 목 데이터 (클리블랜드 vs 보스턴, 03.09)
export const mockFinishedBasketballData: BasketballGameData = {
  ...
  homeTeam: {
    name: '클리블랜드',
    shortName: '클리블랜드',
    logo: 'https://lscdn.psynet.co.kr/livescore/photo/spt/livescore/emb_new/emblem_mid_OT31242.png',
    record: '39승 25패',
    score: 98,
    quarterScores: { q1: 25, q2: 22, q3: 27, q4: 24 },
    recentGames: ['W', 'W', 'L', 'L', 'L'],
    players: [
      { number: 1,  name: '하든',        position: 'G',   minutes: 38, rebounds: 4,  assists: 10, points: 19, fgm: 6,  fga: 15, tpm: 2, tpa: 6,  steals: 2, blocks: 0 },
      { number: 45, name: '미첼',        position: 'G',   minutes: 33, rebounds: 7,  assists: 5,  points: 30, fgm: 10, fga: 20, tpm: 4, tpa: 10, steals: 2, blocks: 1 },
      { number: 4,  name: '모블리',      position: 'C',   minutes: 31, rebounds: 8,  assists: 1,  points: 24, fgm: 9,  fga: 15, tpm: 2, tpa: 5,  steals: 1, blocks: 3 },
      { number: 15, name: '메릴',        position: 'F',   minutes: 29, rebounds: 5,  assists: 4,  points: 5,  fgm: 2,  fga: 6,  tpm: 1, tpa: 4,  steals: 1, blocks: 0 },
      { number: 24, name: '타이슨',      position: 'F',   minutes: 25, rebounds: 6,  assists: 1,  points: 8,  fgm: 3,  fga: 6,  tpm: 0, tpa: 0,  steals: 0, blocks: 1 },
      { number: 14, name: '엘리스',      position: 'Sub', minutes: 24, rebounds: 3,  assists: 0,  points: 0,  fgm: 0,  fga: 3,  tpm: 0, tpa: 2,  steals: 0, blocks: 0 },
      { number: 32, name: '웨이드',      position: 'F',   minutes: 21, rebounds: 3,  assists: 0,  points: 7,  fgm: 3,  fga: 6,  tpm: 1, tpa: 3,  steals: 0, blocks: 0 },
      { number: 8,  name: '슈로더',      position: 'Sub', minutes: 20, rebounds: 3,  assists: 2,  points: 2,  fgm: 1,  fga: 4,  tpm: 0, tpa: 2,  steals: 1, blocks: 0 },
      { number: 3,  name: '브라이언트',  position: 'Sub', minutes: 14, rebounds: 2,  assists: 0,  points: 3,  fgm: 1,  fga: 3,  tpm: 1, tpa: 2,  steals: 0, blocks: 0 },
      { number: 9,  name: '포터 주니어', position: 'Sub', minutes: 4,  rebounds: 1,  assists: 0,  points: 0,  fgm: 0,  fga: 1,  tpm: 0, tpa: 1,  steals: 0, blocks: 0 },
    ],
  },
  awayTeam: {
    name: '보스턴',
    shortName: '보스턴',
    logo: 'https://lscdn.psynet.co.kr/livescore/photo/spt/livescore/emb_new/emblem_mid_OT31244.png',
    record: '43승 21패',
    score: 109,
    quarterScores: { q1: 28, q2: 30, q3: 25, q4: 26 },
    recentGames: ['W', 'W', 'W', 'W', 'L'],
    players: [
      { number: 7,  name: '브라운',    position: 'G',   minutes: 38, rebounds: 9,  assists: 8,  points: 23, fgm: 8,  fga: 16, tpm: 2, tpa: 6,  steals: 1, blocks: 0 },
      { number: 9,  name: '화이트',    position: 'G',   minutes: 36, rebounds: 7,  assists: 5,  points: 6,  fgm: 2,  fga: 8,  tpm: 1, tpa: 4,  steals: 0, blocks: 0 },
      { number: 88, name: '퀘이타',    position: 'C',   minutes: 36, rebounds: 11, assists: 1,  points: 4,  fgm: 2,  fga: 5,  tpm: 0, tpa: 0,  steals: 0, blocks: 0 },
      { number: 11, name: '프릿차드',  position: 'Sub', minutes: 35, rebounds: 3,  assists: 7,  points: 18, fgm: 6,  fga: 12, tpm: 5, tpa: 10, steals: 1, blocks: 0 },
      { number: 0,  name: '테이텀',    position: 'F',   minutes: 27, rebounds: 3,  assists: 2,  points: 20, fgm: 7,  fga: 14, tpm: 3, tpa: 7,  steals: 0, blocks: 0 },
      { number: 55, name: '샤이어만',  position: 'Sub', minutes: 26, rebounds: 10, assists: 0,  points: 16, fgm: 6,  fga: 10, tpm: 2, tpa: 5,  steals: 0, blocks: 0 },
      { number: 30, name: '하우저',    position: 'F',   minutes: 24, rebounds: 4,  assists: 0,  points: 15, fgm: 5,  fga: 10, tpm: 2, tpa: 6,  steals: 0, blocks: 0 },
      { number: 52, name: '가르자',    position: 'Sub', minutes: 12, rebounds: 1,  assists: 1,  points: 7,  fgm: 3,  fga: 5,  tpm: 0, tpa: 1,  steals: 0, blocks: 0 },
      { number: 28, name: '곤살레스',  position: 'Sub', minutes: 7,  rebounds: 1,  assists: 1,  points: 0,  fgm: 0,  fga: 2,  tpm: 0, tpa: 1,  steals: 0, blocks: 0 },
    ],
  },
  gameRecords: [
    { label: '필드골',  home: '22/41', away: '22/46' },
    { label: '3점슛',   home: '13/45', away: '15/38' },
    { label: '자유투',  home: '15/21', away: '20/22' },
    { label: '리바운드', home: 42,     away: 49      },
    { label: '어시스트', home: 23,     away: 25      },
    { label: '턴오버',  home: 7,       away: 10      },
    { label: '스틸',    home: 4,       away: 2       },
    { label: '블록',    home: 6,       away: 0       },
    { label: '파울',    home: 19,      away: 20      },
  ],
  teamComparison: {
    home: {
      winRate: '.609',
