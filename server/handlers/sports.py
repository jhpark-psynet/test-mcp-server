...
async def get_game_details_handler(arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if sport == "baseball":
            ...
            return await _build_baseball_game_response(client, game_id)
...
async def _build_baseball_game_response(
    ...
    state_raw = str(game_info.get("state", "F")).upper()
    ...
    logger.info(
        f"[_build_baseball_game_response] Returning data for "
